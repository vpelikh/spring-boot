...
See xref:maven-plugin:aot.adoc#aot.aot-cache-recording[Maven plugin] and xref:gradle-plugin:aot.adoc#aot.aot-cache-recording[Gradle plugin] documentation for the exact invocation details.
